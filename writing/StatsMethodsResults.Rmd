...
In the Random Forest analysis, latitude best predicted all three population characteristics (Figure 2). The only other predictors that performed nearly as well were region, distance to San Francisco, and longitude, all of which strongly correlate with latitude in this data set. Habitat performed notably poorly, along with population density, and primary access method.
